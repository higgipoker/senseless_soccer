...
Compass Metrics::VectorToCompass (const GameLib::Vector3 &v) {
	...
	if (v.x == 0 && v.y == -1) 			c= NORTH;
	else if (v.x == 1 && v.y == -1) 	c= NORTH_EAST;
	else if (v.x == 1 && v.y == 0) 		c= EAST;
	else if (v.x == 1 && v.y == 1)		c= SOUTH_EAST;
	else if (v.x == 0 && v.y == 1) 		c= SOUTH;
	else if (v.x == -1 && v.y == 1)		c= SOUTH_WEST;
	else if (v.x == -1 && v.y == 0)		c= WEST;
	else if (v.x == -1 && v.y == -1)	c= NORTH_WEST;
