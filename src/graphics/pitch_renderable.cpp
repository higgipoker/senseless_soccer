...
void PitchTiled::Render(GameLib::Window &window) {
  ...
  GameLib::Primitives::Arc(
      ...
      Metrics::MetersToPixels(9.15f), 33, 148, 100, thickness);
  ...
  GameLib::Primitives::Arc(window, metrics.pitch_rect.GetCenter().x,
                           ...
                           Metrics::MetersToPixels(9.15f), 213, 327.4, 100,
                           thickness);
...
void PitchTiled::InitMetrics(PitchMetrics m) {
  ...
  //                                  metrics.pitch_rect.w,
  //                                  metrics.pitch_rect.y));
  //    lines.push_back(GameLib::Line(metrics.pitch_rect.x +
  //    metrics.pitch_rect.w,
  //                                  metrics.pitch_rect.y,
  //                                  metrics.pitch_rect.x +
  //                                  metrics.pitch_rect.w, metrics.pitch_rect.y
  //                                  + metrics.pitch_rect.h));
  //    lines.push_back(GameLib::Line(metrics.pitch_rect.x +
  //    metrics.pitch_rect.w,
  //                                  metrics.pitch_rect.y +
  //                                  metrics.pitch_rect.h,
  ...
  //        GameLib::Line(metrics.pitch_rect.x + metrics.pitch_rect.w / 2 -
  //                      Metrics::YardsToPixels(22) +
  //                      Metrics::YardsToPixels(12), metrics.pitch_rect.y,
  //                      metrics.pitch_rect.x + metrics.pitch_rect.w / 2 -
  //                      Metrics::YardsToPixels(22) +
  //                      Metrics::YardsToPixels(12), metrics.pitch_rect.y +
  //                      Metrics::YardsToPixels(6)));
  ...
  //                      Metrics::YardsToPixels(22) +
  //                      Metrics::YardsToPixels(12), metrics.pitch_rect.y +
  //                      Metrics::YardsToPixels(6), metrics.pitch_rect.x +
  //                      metrics.pitch_rect.w / 2 + Metrics::YardsToPixels(22)
  //                      - Metrics::YardsToPixels(12), metrics.pitch_rect.y +
  //                      Metrics::YardsToPixels(6)));
  //
  //    lines.push_back(
  ...
  //                        Metrics::YardsToPixels(22) +
  //                        Metrics::YardsToPixels(12), metrics.pitch_rect.y +
  //                        metrics.pitch_rect.h, metrics.pitch_rect.x +
  //                        metrics.pitch_rect.w / 2 -
  //                        Metrics::YardsToPixels(22) +
  //                        Metrics::YardsToPixels(12), metrics.pitch_rect.y +
  //                        metrics.pitch_rect.h - Metrics::YardsToPixels(6)));
  //
  //    lines.push_back(GameLib::Line(
  //                        metrics.pitch_rect.x + metrics.pitch_rect.w / 2 -
  //                        Metrics::YardsToPixels(22) +
