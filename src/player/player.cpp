...
void Player::calc_pass_recipients() {
    ...
    Vector3 t1 = physical.position + (temp1.rotated(35, 0, 0)).normalised() * 400;
    Vector3 t2 = physical.position + (temp2.rotated(-35, 0, 0)).normalised() * 400;
...
// DoSlideTackle
// ------------------------------------------------------------
void Player::slide_tackle() { sliding = true; }
